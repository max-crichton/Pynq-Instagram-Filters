...
strath.ac.uk:AXI_Stream:edgedetectfilter:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: edgedetectfilter_0, and set properties
  set edgedetectfilter_0 [ create_bd_cell -type ip -vlnv strath.ac.uk:AXI_Stream:edgedetectfilter:1.0 edgedetectfilter_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins edgedetectfilter_0/s_axis]
  ...
  connect_bd_intf_net -intf_net edgedetectfilter_0_m_axis [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins edgedetectfilter_0/m_axis]
